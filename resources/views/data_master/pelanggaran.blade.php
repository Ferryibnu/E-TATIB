...
<section class="content">
  <div class="container-fluid">
      ...
      <div class="col-12">
        <div class="card shadow mt-4">
          <div class="card-header py-3">
              <h3 class="m-0 font-weight-bold text-dark card-title">Data Master Pelanggaran</h3>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <!-- Modal Tambah -->
              ...
              <div class="modal-dialog " role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Tambah Data Master Pelanggaran</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>
                  <div class="modal-body">
                    <form action="{{route('tambah_pelanggaran')}}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <!-- Tab 1 -->
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <a href="/pelanggaran/hapus/{{$s->id}}" class="btn btn-primary">Iya</a>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <div class="modal-body">
                      <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home{{$s->id}}" role="tabpanel" aria-labelledby="home-tab{{$s->id}}">
                          <form action="/pelanggaran/edit/{{$s->id}}" method="post" enctype="multipart/form-data">
                          {{csrf_field()}}
                          ...
                          <div class="form-row">
                            ...
                            <div class="form-group col-md-2" >
                              <label for="inputStatus">Poin</label>
                              <input type="text" value="{{$s->poin}}" class="form-control" name="poin" required>
                            </div>
                          </div>
    ...
    <div class="drop">
      <a class="float" href="#" title="Tambah Data Master Pelanggaran">
        <i class="fa fa-plus my-float"></i>
      </a>
      <div class="drop-content">
        <a data-toggle="modal" data-target="#tambahModal" href="#" title="Tambah Data Master Pelanggaran">Tambah Data</a>
      </div>
    </div>
    <!-- /.row -->
  </div>
